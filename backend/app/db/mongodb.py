...
from config.settings import MONGODB_URL, DATABASE_NAME, USERS_COLLECTION, ANNOUNCEMENTS_COLLECTION, FACULTY_COLLECTION, STUDENTS_COLLECTION, ATTENDANCE_COLLECTION, EXAMS_COLLECTION, PERMISSIONS_COLLECTION
